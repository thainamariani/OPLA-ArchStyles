...
//--  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --
    public static void main(String[] args) throws FileNotFoundException, IOException, JMException, ClassNotFoundException, Exception {
        ...
        ReaderConfig.setDirTarget("experiment/" + plaName + "/manipulation/");
        ReaderConfig.setDirExportTarget("experiment/" + plaName + "/output/");

        //String plaDirectory = "/home/thaina/NetBeansProjects/OPLA-ArchStyles/test/models/aspect";
